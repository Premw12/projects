        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Edit Company</h4>
                </div>
                <!-- /Title -->
                                            ...
                                            <form class="needs-validation" method="post" novalidate>
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-6 mb-10">
                                                        <label for="validationCustom03">Company Name <i class="fas fa-building"></i></label>
